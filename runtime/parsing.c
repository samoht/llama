...
static void llama_Store_field(value v, size_t i, value fv) { modify(&Field(v, i), fv); }
...
value llama_parse_engine(tables, env, cmd, arg)  /* ML */
     ...
     value cmd, arg;
{
  ...
  push:
    ...
    llama_Store_field (env->symb_start_stack, sp, env->symb_start);
    llama_Store_field (env->symb_end_stack, sp, env->symb_end);
    goto loop;
  ...
  case SEMANTIC_ACTION_COMPUTED:
    ...
    asp = Int_val(env->asp);
    llama_Store_field (env->symb_end_stack, sp, Field(env->symb_end_stack, asp));
    if (sp > asp) {
      /* This is an epsilon production. Take symb_start equal to symb_end. */
      llama_Store_field (env->symb_start_stack, sp, Field(env->symb_end_stack, asp));
    }
    goto loop;

  default:                      /* Should not happen */
    printf("llama parsing engine doesn't work yet\n");
    //    Assert(0); XXX
...
value llama_set_parser_trace(flag)   /* ML */
     value flag;
{
