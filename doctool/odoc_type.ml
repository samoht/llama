...
type variant_constructor = {
    vc_name : string ;
    vc_args : Base.llama_type list ; (** arguments of the constructor *)
...
type t_type = {
    ...
    ty_parameters : Base.llama_type list ;
                    (** type parameters: (type, covariant, contravariant) *)
    ty_kind : type_kind ;
    ty_manifest : Base.llama_type option; (** type manifest *)
