...
external create_nat: int -> nat = "llama_create_nat"
external set_to_zero_nat: nat -> int -> int -> unit = "llama_set_to_zero_nat"
external blit_nat: nat -> int -> nat -> int -> int -> unit = "llama_blit_nat"
external set_digit_nat: nat -> int -> int -> unit = "llama_set_digit_nat"
external nth_digit_nat: nat -> int -> int = "llama_nth_digit_nat"
external set_digit_nat_native: nat -> int -> nativeint -> unit = "llama_set_digit_nat_native"
external nth_digit_nat_native: nat -> int -> nativeint = "llama_nth_digit_nat_native"
external num_digits_nat: nat -> int -> int -> int = "llama_num_digits_nat"
external num_leading_zero_bits_in_digit: nat -> int -> int = "llama_num_leading_zero_bits_in_digit"
external is_digit_int: nat -> int -> bool = "llama_is_digit_int"
external is_digit_zero: nat -> int -> bool = "llama_is_digit_zero"
external is_digit_normalized: nat -> int -> bool = "llama_is_digit_normalized"
external is_digit_odd: nat -> int -> bool = "llama_is_digit_odd"
external incr_nat: nat -> int -> int -> int -> int = "llama_incr_nat"
external add_nat: nat -> int -> int -> nat -> int -> int -> int -> int = "llama_add_nat" "llama_add_nat_native"
external complement_nat: nat -> int -> int -> unit = "llama_complement_nat"
external decr_nat: nat -> int -> int -> int -> int = "llama_decr_nat"
external sub_nat: nat -> int -> int -> nat -> int -> int -> int -> int = "llama_sub_nat" "llama_sub_nat_native"
external mult_digit_nat: nat -> int -> int -> nat -> int -> int -> nat -> int -> int = "llama_mult_digit_nat" "llama_mult_digit_nat_native"
external mult_nat: nat -> int -> int -> nat -> int -> int -> nat -> int -> int -> int = "llama_mult_nat" "llama_mult_nat_native"
external square_nat: nat -> int -> int -> nat -> int -> int -> int = "llama_square_nat" "llama_square_nat_native"
external shift_left_nat: nat -> int -> int -> nat -> int -> int -> unit = "llama_shift_left_nat" "llama_shift_left_nat_native"
external div_digit_nat: nat -> int -> nat -> int -> nat -> int -> int -> nat -> int -> unit = "llama_div_digit_nat" "llama_div_digit_nat_native"
external div_nat: nat -> int -> int -> nat -> int -> int -> unit = "llama_div_nat" "llama_div_nat_native"
external shift_right_nat: nat -> int -> int -> nat -> int -> int -> unit = "llama_shift_right_nat" "llama_shift_right_nat_native"
external compare_digits_nat: nat -> int -> nat -> int -> int = "llama_compare_digits_nat"
external compare_nat: nat -> int -> int -> nat -> int -> int -> int = "llama_compare_nat" "llama_compare_nat_native"
external land_digit_nat: nat -> int -> nat -> int -> unit = "llama_land_digit_nat"
external lor_digit_nat: nat -> int -> nat -> int -> unit = "llama_lor_digit_nat"
external lxor_digit_nat: nat -> int -> nat -> int -> unit = "llama_lxor_digit_nat"

external initialize_nat: unit -> unit = "llama_initialize_nat"
