...
val union: 'elt t -> 'elt t -> 'elt t
  (** Set union. Raises {!Set.Incompatible} if the sets use different orderings. *)

val inter: 'elt t -> 'elt t -> 'elt t
  (** Set intersection. Raises {!Set.Incompatible} if the sets use different orderings. *)

val diff: 'elt t -> 'elt t -> 'elt t
  (** Set difference. Raises {!Set.Incompatible} if the sets use different orderings. *)
