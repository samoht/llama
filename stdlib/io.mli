...
val open_descriptor_out : int -> out_channel = 1 "open_descriptor"
...
val output_byte : out_channel -> int -> unit = 2 "output_char"
        (* Write one 8-bit integer (as the single character with that code)
           on the given output channel. The given integer is taken modulo
           256. *)
val output_binary_int : out_channel -> int -> unit = 2 "output_int"
...
val close_out : out_channel -> unit = 1 "close_out"
...
val open_in_gen : Sys.open_flag list -> int -> string -> in_channel
        (* [open_in_gen mode rights filename] opens the file named
           ...
           of this function. *)
val open_descriptor_in : int -> in_channel = 1 "open_descriptor"
	   ...
	   undefined. *)
val input_char : in_channel -> char = 1 "input_char"
...
val seek_in : in_channel -> int -> unit = 2 "seek_in"
        (* [seek_in chan pos] sets the current reading position to [pos]
           for channel [chan]. This works only for regular files. On
           files of other kinds, the behavior is unspecified. *)
val pos_in : in_channel -> int = 1 "pos_in"
        (* Return the current reading position for the given channel. *)
val in_channel_length : in_channel -> int = 1 "channel_size"
        (* Return the total length (number of characters) of the
           given channel. This works only for regular files. On files of
           other kinds, the result is meaningless. *)
val close_in : in_channel -> unit = 1 "close_in"
...
val fast_output : out_channel -> string -> int -> int -> unit = 4 "output"
val input_scan_line: in_channel -> int = 1 "input_scan_line"
;;
