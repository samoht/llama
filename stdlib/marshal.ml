...
external from_channel: in_channel -> 'a = "llama_input_value"
external from_string_unsafe: string -> int -> 'a
                           = "llama_input_value_from_string"
external data_size_unsafe: string -> int -> int = "llama_marshal_data_size"
