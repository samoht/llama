...
fof_annotated : /* unit */
    FOF LPAREN name COMMA formula_role COMMA fof_top annotations RPAREN PERIOD {Main.set_input_logic "FOF"; !add_fun $3 $5}
;

cnf_annotated : /* unit */
    CNF LPAREN name COMMA formula_role COMMA cnf_top annotations RPAREN PERIOD {Main.set_input_logic "CNF"; !add_fun $3 $5}
;
...
hof_annotated : /* unit */
    HOF LPAREN name COMMA formula_role COMMA typed_constant annotations RPAREN PERIOD {Main.set_input_logic "THF"; add_const_strict $7; !add_fun $3 $5}
  | HOF LPAREN name COMMA formula_role COMMA definition annotations RPAREN PERIOD {Main.set_input_logic "THF"; add_def $7; reset_bound_typevars(); !add_fun $3 $5}
  | HOF LPAREN name COMMA formula_role COMMA thf_logic_formula annotations RPAREN PERIOD {Main.set_input_logic "THF"; 
            match ($5,$7) with
