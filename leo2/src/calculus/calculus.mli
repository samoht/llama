...
(* val cnf_normalize_clauseset : Clauseset.t -> state -> cl_clause list *)
...
(* val cnf_exhaustively_normalize_clauseset : Clauseset.t -> state -> cl_clause list *)
