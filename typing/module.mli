...
val name_of_module : module_ -> string
val values_of_module :
  module_ -> (string, Types.value_desc Types.global) Hashtbl.t
val constrs_of_module :
  module_ -> (string, Types.constr_desc Types.global) Hashtbl.t
val labels_of_module :
  module_ -> (string, Types.label_desc Types.global) Hashtbl.t
val types_of_module :
  module_ -> (string, Types.type_declaration Types.global) Hashtbl.t
val module_table : (string, module_) Hashtbl.t
val new_module : string -> module_
val read_module : string -> string -> module_
val use_extended_interfaces : bool ref
val load_module : string -> module_
val find_module : string -> module_
val kill_module : string -> unit
val opened_modules : module_ ref
...
val defined_module : module_ ref
val start_compiling_interface : string -> unit
val start_compiling_implementation : string -> module_ -> unit
...
val add_global_info :
  (module_ -> (string, 'a Types.global) Hashtbl.t) -> 'a Types.global -> unit
...
val find_desc :
  (module_ -> (string, 'a Types.global) Hashtbl.t) ->
...
val can_omit_qualifier :
  (module_ -> (string, 'a Types.global) Hashtbl.t) -> 'b Types.global -> bool
