...
val transl_exp: Modenv.t -> expression -> lambda
val transl_apply: Modenv.t -> lambda -> expression list -> Location.t -> lambda
val transl_let: Modenv.t -> rec_flag -> (pattern * expression) list -> lambda -> lambda
