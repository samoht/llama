...
#ifndef LLAMA_COMPATIBILITY_H
#define LLAMA_COMPATIBILITY_H
...
#define MAX_NUM_DIMS LLAMA_BA_MAX_NUM_DIMS
#define llama_bigarray_kind llama_ba_kind
#define BIGARRAY_FLOAT32 LLAMA_BA_FLOAT32
#define BIGARRAY_FLOAT64 LLAMA_BA_FLOAT64
#define BIGARRAY_SINT8 LLAMA_BA_SINT8
#define BIGARRAY_UINT8 LLAMA_BA_UINT8
#define BIGARRAY_SINT16 LLAMA_BA_SINT16
#define BIGARRAY_UINT16 LLAMA_BA_UINT16
#define BIGARRAY_INT32 LLAMA_BA_INT32
#define BIGARRAY_INT64 LLAMA_BA_INT64
#define BIGARRAY_LLAMA_INT LLAMA_BA_LLAMA_INT
#define BIGARRAY_NATIVE_INT LLAMA_BA_NATIVE_INT
#define BIGARRAY_COMPLEX32 LLAMA_BA_COMPLEX32
#define BIGARRAY_COMPLEX64 LLAMA_BA_COMPLEX64
#define BIGARRAY_KIND_MASK LLAMA_BA_KIND_MASK
#define llama_bigarray_layout llama_ba_layout
#define BIGARRAY_C_LAYOUT LLAMA_BA_C_LAYOUT
#define BIGARRAY_FORTRAN_LAYOUT LLAMA_BA_FORTRAN_LAYOUT
#define BIGARRAY_LAYOUT_MASK LLAMA_BA_LAYOUT_MASK
#define llama_bigarray_managed llama_ba_managed
#define BIGARRAY_EXTERNAL LLAMA_BA_EXTERNAL
#define BIGARRAY_MANAGED LLAMA_BA_MANAGED
#define BIGARRAY_MAPPED_FILE LLAMA_BA_MAPPED_FILE
#define BIGARRAY_MANAGED_MASK LLAMA_BA_MANAGED_MASK
#define llama_bigarray_proxy llama_ba_proxy
#define llama_bigarray llama_ba_array
#define Bigarray_val Llama_ba_array_val
#define Data_bigarray_val Llama_ba_data_val
...
#define MAX_BIGARRAY_MEMORY LLAMA_BA_MAX_MEMORY
...
#endif /* LLAMA_NAME_SPACE */
#endif /* LLAMA_COMPATIBILITY_H */
