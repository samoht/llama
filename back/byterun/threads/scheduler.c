...
CAMLprim value thread_initialize(value unit)       /* ML */
{
...
CAMLprim value thread_initialize_preemption(value unit)     /* ML */
{
...
CAMLprim value thread_yield(value unit)        /* ML */
{
...
CAMLprim value thread_sleep(value unit)        /* ML */
{
  Assert(curr_thread != NULL);
  check_callback();
...
CAMLprim value thread_select(value arg)        /* ML */
{
  double date;
  check_callback();
...
CAMLprim value thread_delay(value time)          /* ML */
{
...
CAMLprim value thread_join(value th)          /* ML */
{
  check_callback();
  Assert(curr_thread != NULL);
...
CAMLprim value thread_wait_pid(value pid)          /* ML */
{
  Assert(curr_thread != NULL);
  check_callback();
...
CAMLprim value thread_self(value unit)         /* ML */
{
  Assert(curr_thread != NULL);
