...
external get_global_data : int -> Llama_obj.t = "caml_llama_get_global"
external set_global_data : int -> Llama_obj.t -> unit = "caml_llama_set_global"
...
external interprete : string -> int -> int -> Llama_obj.t = "caml_llama_interpret"
