...
let verified_refs = ref Set.empty_generic
...
let (module_aliases : (Odoc_name.t, Odoc_name.t * alias_state) Hashtbl.t) = Hashtbl.create 13 ;;
...
let known_elements = ref Map.empty_generic
